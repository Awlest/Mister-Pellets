...
export const CITIES: CityData[] = [
  ...
  },
  {
    ...
    context:
      "Beaucoup de remplacement de chaudières mazout par des hydros Dielle dans les maisons ouvrières des années 50-70. Sur les maisons modernes de Mont-sur-Marchienne ou Gilly, c'est le canalisable EK63 qui domine pour gérer plusieurs pièces sans gros chantier.",
    recommendedModels: ["dielle-iride-22", "ek63-tweed-90", "ferlux-pyl-10"],
    testimonial: {
  ...
  },
  {
    ...
    recommendedModels: ["ek63-like-80", "edilkamin-blade-9kw", "dielle-iride-22"],
    testimonial: {
