...
export default function Loading() {
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-mp-cream py-16">
      <div className="mp-shell animate-pulse">
        <div className="mp-measure h-8 w-32 bg-mp-sand/50 rounded-full mb-6 mx-auto" />
        <div className="mp-measure h-12 w-3/4 bg-mp-sand/40 rounded-lg mb-4 mx-auto" />
        <div className="mp-measure h-12 w-2/3 bg-mp-sand/40 rounded-lg mb-8 mx-auto" />
        <div className="mp-measure space-y-3 max-w-xl mx-auto">
